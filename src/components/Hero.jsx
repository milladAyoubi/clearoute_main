...
const Hero = () => {
  return (
    <section className='h-screen lg:h-[60vh] bg-gradient-to-t from-gradient' id='home'>
    <div className="container mx-auto  h-full lg:pt-10">
      <div className="flex flex-col lg:flex-row justify-center text-center lg:text-left items-center lg:gap-x-0 lg:justify-start h-full">
        ...
        <p className='bg-accent/10 w-[205px] text-accent font-medium py-2 px-6 rounded-[10px]'>
          Netbook Community
        </p>
        </div>
          ...
          More than 2 billion people in over countries use socibook <br></br> to stay in touch with friends & family.
          </p>
