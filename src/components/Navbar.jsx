...
const Navbar = () => {
  ...
  return (
    <header className="fixed w-full max-w-[1920px] mx-auto z-20 transition-all duration-300 py-6  border-b-2 border-grey">
    <div className="xl:container mx-auto  ">
    
    <nav className={` 
      flex flex-col bg-white gap-y-6 overflow-hidden font-boldxl:gap-x-8 xl:h-max xl:bg-transparent xl:pb-0 transition-all duration-150 text-center xl:text-left uppercase
